...
PROTECTED_SETTINGS
  ...
  depends_on = [
    azurerm_virtual_machine_extension.fifth-vminsights_agent
  ]
}
...
resource "azurerm_virtual_machine_extension" "third-windows_monitoring_agent" {
  count                      = var.rdsh_count
...
resource "azurerm_virtual_machine_extension" "fourth-VMDiagnosticsSettings_host" {
  count                      = var.rdsh_count
...
PROTECTEDSETTINGS
  ...
  depends_on = [
    azurerm_virtual_machine_extension.third-windows_monitoring_agent
  ]
}

resource "azurerm_virtual_machine_extension" "fifth-vminsights_agent" {
  count                      = var.rdsh_count
  ...
  depends_on = [
    azurerm_virtual_machine_extension.fourth-VMDiagnosticsSettings_host
  ]
}
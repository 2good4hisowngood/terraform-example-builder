...
#   description = "Size of app Master Image server"
# }

# variable "ad_rds_size" {
#   type        = string
#   default     = "Standard_B2s"
#   description = "Size of Active Directory servers"
# }
...
variable "rg1" {}
variable "rg2" {}
variable "import_aadds_vnets" {}
variable "import_bastion_vnet" {}
...
variable "test_enabled_client_accounts" {}